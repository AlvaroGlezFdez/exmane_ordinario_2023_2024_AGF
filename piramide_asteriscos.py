...
#Creación de la estructura condicional que verificarña si el núemro del usuario es mayor que 1
#Damos una segunda oportunidad en el condicional de meter un valor correcto y sino detenemos la ejecución
